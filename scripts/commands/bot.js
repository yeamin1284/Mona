...
module.exports = {
  ...
  start: async function ({ nayan, events, args, Users }) {
    try {
      ...
      if (!msg) {
        const greetings = [
          "চুমু খাওয়ার বয়স টা  চকলেট🍫খেয়ে উড়িয়ে দিলাে আমার বস Ariyan🤗",
          "আমি তোমাকে চাইনা, আবার চাই।তোমাকে আমার না হলেও চলবে এমন অভিনয় করে যাই😁🥀❤️",
          ...
          "আমাকে এতো না ডেকে বস Ariyan কে ২০,১৫,১৩,১.কে দে 😞",
          "সুখের এতো মূল্য ! দুঃখ না থাকলে বুঝতামই না.",
          "তোমাকে মুগ্ধ করার মতো সুন্দর চে'হারা নেই আমার তবে তোমাকে ভালোবাসার মতো সুন্দর একটা মন আছে..! '🥹❤️‍🩹"
        ];
